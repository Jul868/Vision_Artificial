...
video_salida = cv2.VideoWriter(nombre_video_salida, fourcc, 20.0, (360, 640))
...
def main():
    ...
    while(capture.isOpened()):
        ...
        franja=franja/255
        contours, hie = cv2.findContours(videoBinary, cv2.RETR_LIST, cv2.CHAIN_APPROX_NONE)
            ...
            for cnt in contours:
                ...
                if ( area > 500):
                    ...
                    if (c > 0.8):
                        ...
                        cv2.waitKey(5)
                        if(area > 30000 and area < 40000 and BMIL):
                            moneda_mil += 1
                            BMIL = False
                        elif(area < 28000):
                            BMIL = True
                        ...
                        if(area > 23000 and area < 24000 and BCIN):
                            moneda_quin += 1
                            BCIN = False
                        elif(area < 21000):
                            BCIN = True
                        ...
                        if(area > 19000 and area < 21000 and B200):
                            moneda_200 += 1
                            B200 = False
                        elif(area < 14000):
                            B200 = True
                        print("Monedas de 200:", moneda_200)
                        if(area > 21000 and area < 22000 and B100):
                            moneda_100 += 1
                            B100 = False
                        elif(area < 9000):
                            B100 = True
                        print("Monedas de 100:", moneda_100)
                        if(area > 10000 and area < 12000 and B50):
                            moneda_50 += 1
                            B50 = False
                        elif(area < 4000):
                            B50 = True
